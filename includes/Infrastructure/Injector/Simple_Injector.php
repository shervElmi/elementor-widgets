...
use ReflectionClass;
use Insider\Elementor_Widgets\Infrastructure\Instantiator;
use Insider\Elementor_Widgets\Infrastructure\Injector;
use Insider\Elementor_Widgets\Exception\FailedToMakeInstance;
 ...
 * @since 1.0.0
 */
final class Simple_Injector implements Injector {
	...
	/**
	 * Instantiate a Simple_Injector object.
	 *
	 * @since 1.0.0
	 *
	 ...
	 * @since 1.0.0
	 *
	 * @param Injection_Chain $injection_chain    Injection chain to track
	 *                                           resolutions.
	 ...
	 * @return Injection_Chain Modified Injection chain
	 */
