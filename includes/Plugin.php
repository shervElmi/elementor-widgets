...
use Insider\Elementor_Widgets\Infrastructure\Service_Based_Plugin;
...
final class Plugin extends Service_Based_Plugin {
	 ...
	 * @var string
	 */
	const HOOK_PREFIX = 'insider.elementor_widgets.';
	 ...
	 */
	const SERVICES = [
		'elementor.category' => Elementor\Category::class,
		'elementor.widgets'  => Elementor\Widgets::class,
		'tools.vite'         => Tools\Vite::class,
	];
