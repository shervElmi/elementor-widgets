...
use Insider\Elementor_Widgets\Traits\Str;
...
class Assets {
	...
	public function register_script_asset( string $script_handle, array $script_dependencies = [] ): void {
		if ( isset( $this->register_scripts[ $script_handle ] ) || INEW_DEV_MODE ) {
			return;
		}
	...
	public function register_style_asset( string $style_handle, array $style_dependencies = [] ): void {
		if ( isset( $this->register_styles[ $style_handle ] ) || INEW_DEV_MODE ) {
			return;
		}
